...
public class Main extends JFrame implements ActionListener {
	 ...
	 */
	public Main() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Sam Juanite\\eclipse-workspace\\Software Engineering\\src\\images\\ssct.jpg"));
		setResizable(false);
		setEnabled(true);
		...
		JButton btnNewButton = new JButton("Search/Rent");
		btnNewButton.setFont(new Font("Tahoma", Font.BOLD, 12));
		btnNewButton.setBounds(10, 11, 175, 48);
		leftContentPanel.add(btnNewButton);
		
		JButton btnRent = new JButton("Return");
		btnRent.setFont(new Font("Tahoma", Font.BOLD, 12));
		btnRent.setBounds(10, 70, 175, 48);
		leftContentPanel.add(btnRent);
		
		JButton btnUserinformation = new JButton("User Information");
		btnUserinformation.setFont(new Font("Tahoma", Font.BOLD, 12));
		btnUserinformation.setBounds(10, 129, 175, 48);
		...
		btnUserManagement.setBounds(10, 185, 175, 48);
		...
		btnBookManagement.setBounds(10, 249, 175, 48);
		...
		btnActivityLogs.setBounds(10, 366, 175, 48);
